...
// SECTION 1: verify idtoken
// copy paste from ajaxcheckidtoken.php
...
try {
    ...
    echo "FAILED: JWT signature verification failed"; exit;
}
...
// SECTION 2: business logic to register user
// stubbed
echo "USER REGISTERED! <br>";
echo "phone: ".$_REQUEST["phone"]."<br>";
echo "name: ".$_REQUEST["txtNama"]."<br>";
echo "password: ".$_REQUEST["txtPassword"]."<br>";
if($_REQUEST["txtPassword"] == $_REQUEST["txtPasswordConfirm"]) echo "OK, Confirm password matched!";
else echo "FAILED, Confirm password mismatch!";
